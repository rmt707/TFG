    ...
    <body>    
        ...
        <nav id=menu>
            <ul>
                ...
                <li><a href="info_mes">Info por mes</a></li>
        ...
        <div id="registro" style="overflow-x:auto; padding-left: 10px; padding-right: 10px;">
            <table>
                <h5>Información de Humedad (%) y Temperatura (ºC) por Mes</h5>
                <tr>
